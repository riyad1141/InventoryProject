...
@section('content')
                ...
                <div class="shadow-sm h-100 bg-white rounded-3 p-3">
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <label for="discountP"></label><input onkeydown="return false" value="0" min="0" type="number" step="0.25" onchange="DiscountChange()" class="form-control w-40 form-control-sm" id="discountP"/>
                            <p>
                                <button onclick="InvoiceCreate()" class="btn btn-sm my-2 bg-gradient-primary w-40">Confirm</button>
                            </p>
                        </div>
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-12 p-1">
                                    ...
                                    <label for="PId"></label><input type="text" class="form-control" id="PId">
                                    <label class="form-label">Product Name *</label>
                                    <label for="PName"></label><input type="text" class="form-control" id="PName">
                                    <label class="form-label">Product Price *</label>
                                    <label for="PPrice"></label><input type="text" class="form-control" id="PPrice">
                                    <label class="form-label">Product Qty *</label>
                                    <label for="PQty"></label><input type="text" class="form-control" id="PQty">
                                </div>
                            </div>
                        </div>
                    </form>
    ...
    <script>
        ...
        async  function ProductList() {
            ...
            response.data.forEach(function (item,index) {
                let row=`<tr class="text-xs">
                               <td> <img class="w-10" src="${item['image_url']}" alt="image"/> ${item['name']} ($ ${item['price']})</td>
        ...
        async  function InvoiceCreate() {
            ...
            if(CId.length===0){
                ...
                let response = await axios.post("/InvoiceCreate",Data);
                hideLoader();
