...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('path-to-datatables-css/datatables.min.css')}}">
    <script type="text/javascript" charset="utf8" src="{{asset('path-to-datatables-js/datatables.min.js')}}"></script>
